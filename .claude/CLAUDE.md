...
```bash
sonar analyze agentic --project org.sonarsource.java:jdt-package --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project org.sonarsource.java:jdt-package --depth DEEP
```
